    ...
    <div class="px-5 pt-5 pb-4 border-b border-border flex items-center justify-between">
      ...
      <div class="flex items-center gap-2.5">
        ...
        <button
          ...
          class="flex items-center text-fg-subtle hover:text-fg-muted transition-colors duration-150 p-0 bg-transparent border-none cursor-pointer"
        ...
        <a
          ...
          class="flex items-center text-fg-subtle hover:text-fg-muted transition-colors duration-150"
          title="Documentation"
        >
